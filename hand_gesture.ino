...
const int trigPin1 = 8; // the number of the trigger output pin ( sensor 1 )
const int echoPin1 = 9; // the number of the echo input pin ( sensor 1 )     
const int trigPin2 = 6;  // the number of the trigger output pin ( sensor 2 ) 
const int echoPin2 = 7;  // the number of the echo input pin ( sensor 2 ) 
...
}                // this condition becomes true if we move…
